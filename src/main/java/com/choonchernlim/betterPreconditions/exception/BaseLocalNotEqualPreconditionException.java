 ...
 */
public class BaseLocalNotEqualPreconditionException extends PreconditionException {
     ...
     */
    public BaseLocalNotEqualPreconditionException(final BaseLocal firstBaseLocalValue,
