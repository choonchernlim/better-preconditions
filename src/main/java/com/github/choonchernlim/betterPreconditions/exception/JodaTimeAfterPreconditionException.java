...
/**
 * This exception is thrown if the first value is after second value.
 */
public class JodaTimeAfterPreconditionException extends PreconditionException {
     ...
     */
    public JodaTimeAfterPreconditionException(final BaseLocal firstBaseLocalValue,
                                              final String firstBaseLocalLabel,
                                              final BaseLocal secondBaseLocalValue,
                                              final String secondBaseLocalLabel) {
        super(String.format("%s [ %s ] must not be after %s [ %s ]",
                            firstBaseLocalLabel,
                            firstBaseLocalValue,
