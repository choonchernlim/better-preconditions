...
/**
 * This exception is thrown if the first value is not before second value.
 */
public class JodaTimeNotBeforePreconditionException extends PreconditionException {
     ...
     */
    public JodaTimeNotBeforePreconditionException(final BaseLocal firstBaseLocalValue,
                                                  final String firstBaseLocalLabel,
                                                  final BaseLocal secondBaseLocalValue,
                                                  final String secondBaseLocalLabel) {
        super(String.format("%s [ %s ] must be before %s [ %s ]",
                            firstBaseLocalLabel,
                            firstBaseLocalValue,
