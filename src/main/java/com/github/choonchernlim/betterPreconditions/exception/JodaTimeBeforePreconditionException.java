...
/**
 * This exception is thrown if the first value is before second value.
 */
public class JodaTimeBeforePreconditionException extends PreconditionException {
     ...
     */
    public JodaTimeBeforePreconditionException(final BaseLocal firstBaseLocalValue,
                                               final String firstBaseLocalLabel,
                                               final BaseLocal secondBaseLocalValue,
                                               final String secondBaseLocalLabel) {
        super(String.format("%s [ %s ] must not be before %s [ %s ]",
                            firstBaseLocalLabel,
                            firstBaseLocalValue,
